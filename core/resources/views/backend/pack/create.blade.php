...
<div class="container-fluid" style="height: calc(100vh - 80px); overflow-y: auto; padding-bottom: 20px;">
    ...
    <div class="row px-3 pt-3 pb-2 align-items-center">
        <div class="col-md-8">
            <h3 class="fw-bold mb-1">
                <i class="bi bi-plus-circle me-2 text-primary"></i> Add New Pack
            </h3>
            <small class="text-muted">Fill the form below to add a new pack</small>
        </div>

        <div class="col-md-4 text-md-end mt-2 mt-md-0">
            <a href="{{ url('admin/pack') }}" class="btn btn-outline-secondary rounded-pill px-4">
    ...
    <div class="card border-0 shadow-sm mx-3 mt-3 product-card">
        <div class="card-body p-4">
            ...
            <form action="/admin/pack/store" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control editor"
                                  name="details"
                                  rows="5"
                                  placeholder="Enter pack details"></textarea>
                    </div>
                    ...
                    <div class="col-12">
                        <label class="form-label fw-semibold">
                            ...
                            Pack Cover Image <span class="text-danger">*</span>
                        </label>
                        <input type="file"
                               accept="image/*"
                               class="form-control"
                    ...
                    <div class="col-12 mt-2">
                        <button type="submit" class="btn btn-success px-4 rounded-pill w-100 w-md-auto">
                            <i class="bi bi-check-circle me-1"></i> Save Pack
                        </button>
                    </div>
